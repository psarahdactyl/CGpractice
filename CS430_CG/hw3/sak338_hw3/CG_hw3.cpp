...
void transform(float scaleFactor, float radians, int translateX, int translateY)
{
	...
	for (Shape* s : shapes)
		s->transform(scaleFactor, scaleFactor, radians, translateX, translateY);
}
...
int main( int argc, char **argv )
{
	...
	int viewUpperBoundX = 200;
	int viewUpperBoundY = 200;
	...
	worldToViewport(lowerBoundX, upperBoundX, lowerBoundY, upperBoundY,
 					viewLowerBoundX, viewUpperBoundX, viewLowerBoundY, viewUpperBoundY); 	
